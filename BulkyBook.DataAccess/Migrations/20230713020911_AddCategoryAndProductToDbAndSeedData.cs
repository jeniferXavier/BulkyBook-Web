...
{
    /// <inheritdoc />
    public partial class AddCategoryAndProductToDbAndSeedData : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 7, 12, 19, 9, 11, 572, DateTimeKind.Local).AddTicks(8408), 1, "Action" },
                    { 2, new DateTime(2023, 7, 12, 19, 9, 11, 572, DateTimeKind.Local).AddTicks(8415), 2, "SciFic" },
                    { 3, new DateTime(2023, 7, 12, 19, 9, 11, 572, DateTimeKind.Local).AddTicks(8419), 3, "History" }
                });
